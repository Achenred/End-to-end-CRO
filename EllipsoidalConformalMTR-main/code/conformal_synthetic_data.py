...
for k in range(n_kfold):
    ...
    title = "standard_empirical_synthetic.jpg"
    ...
    title = "normalized_empirical_synthetic.jpg"
    ...
    title = "standard_ellipse_synthetic.jpg"
    ...
    (
        ...
        normalized_ellipse_efficiency, binary_flag
    ) = local_ellipse_validity_efficiency(
